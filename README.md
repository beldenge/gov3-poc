...
`java -jar -Dkey-length=3 -Dfunction-type=GOV3 path/to/gov3-poc-1.1.0-SNAPSHOT.jar`
...
`java -jar -Dkey-length=3 -Dfunction-type=GOV3 -Dcompacted=true path/to/gov3-poc-1.1.0-SNAPSHOT.jar`
...
`java -jar -Dinput-directory=some/different/directory -Doutput-directory=yet/another/directory path/to/gov3-poc-1.1.0-SNAPSHOT.jar`
...
`java -jar -Xms8G -Xmx8G path/to/gov3-poc-1.1.0-SNAPSHOT.jar`
...
`java -jar -Dit.unimi.dsi.sux4j.mph.threads=8 path/to/gov3-poc-1.1.0-SNAPSHOT.jar`